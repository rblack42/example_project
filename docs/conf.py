...
latex_documents = [
  ('index', 'example_project.tex', u'example\\_project Documentation',
...
man_pages = [
    ('index', 'example_project', u'example_project Documentation',
     [u'Roie R. Black'], 1)
]
...
texinfo_documents = [
  ('index', 'example_project', u'example_project Documentation',
   u'Roie R. Black', 'example_project', 'One line description of project.',
   'Miscellaneous'),
]
